  ...
  render() {
    ...
    return (
      <div className="container ContactPage">
        ...
        />
        {this.state.success && (
          <Event title="Thank you">
            <p>
              Your message has been received. Click <Link to="/">here</Link> to go back to the main
              page.
            </p>
          </Event>
        )}
        {this.state.success === false && (
          <Event title="Uh oh...">
            <p>
              Your message could not be sent. Click <Link to="/">here</Link> to go back to the main
              page.
            </p>
          </Event>
        )}
        {this.state.success === null && (
          <div className="contact-card">
            {isReferred && (
              <button className="back__button" onClick={this.goBack}>
            ...
            <form className="contact__input" onSubmit={this.handleSubmit}>
              ...
              <textarea
                ...
                required
              ></textarea>
              <button disabled={this.state.isLoading} type="submit" className="contact__buton">
                Send
              </button>
            </form>
          </div>
